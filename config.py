...
train_arg.add_argument(
    ...
    "batch size")
train_arg.add_argument(
    "--gpu_id", type=str, default='10', help='id(s) for CUDA_VISIBLE_DEVICES')
train_arg.add_argument(
...
train_arg.add_argument(
    "--log_base", type=str, default="./OANet/Exper3/whole2/log/", help=""
...
test_arg.add_argument(
    "--model_path", type=str, default="./OANet/Exper3/whole2/log/train", help=""
    "saved best model path for test")
test_arg.add_argument(
    "--res_path", type=str, default="./OANet/Exper3/whole2/log/test", help=""
